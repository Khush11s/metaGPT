...
PROMPT = """You are an AI developer, trying to write a program that generates code for users based on their intentions and user provided coding language.
...
Only list the file paths you will write and return them as a  string list.
Do not add any other explanations, just return a  string list."""
