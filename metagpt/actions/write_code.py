...
PROMPT_TEMPLATE = """
NOTICE
Role: You are a professional engineer; the main goal is to write  c elegant, modular, easy to read and maintain  code (but you can also use other programming language)
ATTENTION: Use '##' to SPLIT SECTIONS, not '#'. Output format carefully referenced "Format example".

## Code: {filename} Write code in user provide language, based on the following list and context.
