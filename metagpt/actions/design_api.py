...
{format_example}
-----
Role: You are an architect; the goal is to design SOTA design in user provided coding language; make the best use of good open source tools
...
## package name: Provide as  str with  triple quoto, concise and clear, characters only use a combination of all lowercase and underscores

## File list: Provided as list[str], the list of ONLY REQUIRED files needed to write the program(LESS IS MORE!). Only need relative paths, ALWAYS write a main file here
...
class WriteDesign(Action):
    ...
    def _save(self, context, system_design):
        if isinstance(system_design, ActionOutput):
            ...
            ws_name = CodeParser.parse_str(block="package name", text=content)
        else:
